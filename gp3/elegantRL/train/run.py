...
class Learner(Process):
    def __init__(self, learner_pipe: Pipe, worker_pipes: List[Pipe], evaluator_pipe: Pipe, args: Config):
        super().__init__()
    ...
    def run(self):
        ...
        while if_train:
            ...
            if self.eval_pipe.poll():  # whether there is any data available to be read of this pipe
                ...
                actor = agent.act  # so Learner send an actor to evaluator for evaluation.
            else:
                actor = None
