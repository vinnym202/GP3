...
from elegantRL.agent.net import ActorPPO, CriticPPO
from elegantRL.agent.net import ActorDiscretePPO
...
class AgentPPO(AgentBase):
    ...
    def update_net(self, buffer) -> Tuple[float, ...]:
        with torch.no_grad():
            ...
            bs = 2 ** 10  # set a smaller 'batch_size' to avoid running out of GPU memory.
